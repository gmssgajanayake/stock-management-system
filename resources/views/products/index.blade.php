...
@section('content')
    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <button id="createProductBtn" class="w-full sm:w-auto px-5 py-2.5 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg shadow-sm transition-colors focus:ring-2 focus:ring-green-500 focus:outline-none">
            + Add New Product
        </button>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                    <tr>
                        ...
                        <th class="px-6 py-4 sortBtn cursor-pointer hover:text-gray-900 transition-colors" data-sort="price">
